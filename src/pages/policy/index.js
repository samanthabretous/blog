...
export default class PolicyPage extends React.Component {
  render() {
    return (
      <Layout>
        <NavbarSimple />
        <section className={stylesheet.policy}>
          <h1>Privacy Policy</h1>

          <p>Effective date: December 14, 2019</p>

          <p>
            Samantha Bretous ("us", "we", or "our") operates the
            www.samanthabretous.com website (hereinafter referred to as the
            "Service").
          </p>
          ...
          <p>
            ...
            Samantha Bretous has been created with the help of{" "}
          ...
          <ul>
            <li>
              ...
              <p>
                Service is the www.samanthabretous.com website operated by
                Samantha Bretous
              </p>
            </li>
            <li>
          ...
          <p>Samantha Bretous uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            Samantha Bretous will take all steps reasonably necessary to ensure
          ...
          <p>
            Samantha Bretous may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Samantha Bretous
            </li>
            <li>
          ...
          <ul>
            <li>By email: sam@samanthabretous.com</li>
          </ul>
        </section>
      </Layout>
    );
